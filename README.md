...
| Hero banner | `index.html` | Sample visualization only. Swap with your own image file by replacing the `<canvas>` with `<img class="cover">` |
| Work 01 banner | `work-basin-subsidence.html` | Sample visualization only. Swap with your own image file by replacing the `<canvas>` with `<img class="cover">` |
